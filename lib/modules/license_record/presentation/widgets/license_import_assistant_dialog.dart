  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 8),
        Text(
          '授权记录导入：授权编号、应用版本号、绑定用户、有效期、首次激活截止、状态、发码时间、创建时间、更新时间、授权码、操作标记为必填；用户编号、操作人、备注为选填。',
        ),
        SizedBox(height: 8),
        Text(
          '批量生码导入：应用版本号、绑定用户、有效期天数、永久授权、操作标记为必填；用户编号、首次激活截止日期、操作人、备注为选填。永久授权为“否”时有效期天数必须大于 0。',
        ),
        SizedBox(height: 8),
